...
<div>
    <div style="margin: 15px 0; display:flex; justify-content: space-between; height: 50px; align-items: center">
        ...
        echo '
                <div class="user-info" style="margin-left: 75px"><i class="fas fa-user" style="margin-right: 7px"></i>' . $ThongTinGV['MaGV'] . ' | <span style="font-style: italic">' . $ThongTinGV['TenGV'] . '</span>' . '</div>
                ';
        ?>
        <div id="dashboard-title">DANH SÁCH CÁC LỚP ĐƯỢC PHÂN CÔNG</div>
        <form method="post">
            <button style="margin-right: 77px" type="submit" class="logout-button" name="logout">Đăng xuất <i class="fas fa-sign-out-alt"
    ...
    <form action="Dashboard.php" method="post">
        <div style="text-align:center; margin: 15px">
            ...
            <select name="filter-mahocky" style="width: 100px">
