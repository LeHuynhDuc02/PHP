...
//    echo $listMaDiem;
    $query_check1 = "SELECT
                    CASE
                        ...
                        WHEN DiemMieng > 4 AND DiemMieng <= 8 THEN 'Từ >4-8'
    ...
    $query_check2 = "SELECT
                        CASE
                            ...
                            WHEN Diem15Phut1 > 4 AND Diem15Phut1 <= 8 THEN 'Từ >4-8'
    ...
    $query_check3 = "SELECT
                        CASE
                            ...
                            WHEN Diem15Phut2 > 4 AND Diem15Phut2 <= 8 THEN 'Từ >4-8'
    ...
    $query_check4 = "SELECT
                        CASE
                            ...
                            WHEN Diem1Tiet > 4 AND Diem1Tiet <= 8 THEN 'Từ >4-8'
    ...
    $query_check5 = "SELECT
                        CASE
                            ...
                            WHEN DiemGiuaKi > 4 AND DiemGiuaKi <= 8 THEN 'Từ >4-8'
    ...
    $query_check6 = "SELECT
                        CASE
                            ...
                            WHEN DiemThi > 4 AND DiemThi <= 8 THEN 'Từ >4-8'
    ...
    $query_check7 = "SELECT
                        CASE
                            WHEN DiemTB >= 0 AND DiemTB <= 4 THEN 'Từ 0-4'
                            WHEN DiemTB > 4 AND DiemTB <= 8 THEN 'Từ >4-8'
                            WHEN DiemTB > 8 AND DiemTB <= 10 THEN 'Từ >8-10'
                        END AS LoaiDiem,
                        COUNT(*) AS SoLuong
                        FROM Diem
                        WHERE
